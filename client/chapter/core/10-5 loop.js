...
// const keys = Object.keys(randomUser); //객체의 키를 모아 하나의 배열로반환
// const values = Object.values(randomUser); // 객체의 값을 모아 하나의 배열로 반환
// const entries = Object.entries(randomUser); // 객체의 키와 값을 모야 하나의 배열로 반환
